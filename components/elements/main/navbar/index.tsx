...
import { faBars, faFlag, faLightbulb, faSun, faMoon, faGhost } from '@fortawesome/free-solid-svg-icons';
...
const Navbar = (props) => {
    ...
    // is url contains /blog or /projects
    const forceEnglish = router.asPath.startsWith('/blog') || router.asPath.startsWith('/projects');
