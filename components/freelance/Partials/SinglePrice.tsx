                ...
                <div className="mx-auto bg-base-100 mt-16 max-w-2xl rounded-3xl ring-1 ring-gray-200 sm:mt-20 lg:mx-0 lg:flex lg:max-w-none">
                    <div className="p-8 sm:p-10 lg:flex-auto">
                        ...
                        <div className="mt-10 flex items-center gap-x-4">
                            <h4 className="flex-none text-sm font-semibold leading-6">{t("FREELANCE.PRICE.INCLUDES")}</h4>
                    ...
                    <div className="-mt-2 p-2 lg:mt-0 lg:w-full lg:max-w-md lg:flex-shrink-0">
                        <div className="rounded-2xl bg-base-300 py-10 text-center ring-1 ring-inset ring-gray-900/5 lg:flex lg:flex-col lg:justify-center lg:py-16">
                            <div className="mx-auto max-w-xs px-8">
                                <p className="text-cbase font-bold">{props.priceTitle} <span className="text-lg font-normal">{props.priceSubtitle}</span></p>
                                <p className="mt-6 flex items-baseline justify-center gap-x-2">
                                    <span className="text-5xl font-bold tracking-tight "><FontAwesomeIcon icon={props.priceCurrencyIcon as IconDefinition}  className="w-10 h-10" />{props.price} <span className="text-base font-normal">{props.pricePostfix}</span></span>
                                </p>
