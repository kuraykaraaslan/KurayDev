            ...
            <div className="hero-content flex-col lg:flex-row-reverse mx-4 md:mx-20">
                ...
                <div className="flex-1 lg:mr-12">
                    ...
                    <Link href="https://www.npmjs.com/package/control-view-cube">
                        <p className="btn bg-green-500 text-white hover:bg-green-600"><FontAwesomeIcon icon={faChrome} style={{ width: '1.0rem', height: '1.0rem' }} /> Chrome Extension</p>
                    </Link>
                    <Link href="https://github.com/kuraykaraaslan/Resume">
                        <p className="btn bg-red-500 text-white hover:bg-red-600 ml-2"><FontAwesomeIcon icon={faOpera} style={{ width: '1.0rem', height: '1.0rem' }} /> Opera Extension</p>
                    </Link>
                </div>
            </div>
        </div>
