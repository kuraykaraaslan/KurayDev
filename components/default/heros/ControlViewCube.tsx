            ...
            <div className="hero-content flex-col lg:flex-row mx-4 md:mx-20">
                <div className="max-w-sm rounded-lg shadow-2xl hidden lg:block">
                    <div className="mockup-browser border bg-base-300">
                        ...
                        <img src="https://raw.githubusercontent.com/kuraykaraaslan/control-view-cube/main/static/donut.gif" alt="cover" className="mockup-browser-img" />
                    </div>
                </div>
                <div className="flex-1 lg:ml-12">
                    ...
                    <Link href="https://www.npmjs.com/package/control-view-cube">
                        <p className="btn btn-primary">
                            <FontAwesomeIcon icon={faNpm} style={{ width: '1.0rem', height: '1.0rem' }} /> npm package</p>
