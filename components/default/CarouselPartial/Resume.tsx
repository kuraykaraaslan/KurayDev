      ...
      <div className="hero-content flex-col lg:flex-row mx-4 md:mx-20">
        <div className="max-w-sm rounded-lg shadow-2xl hidden lg:block">
          <div className="mockup-browser border bg-base-300">
            ...
            <img
              src="https://github.com/kuraykaraaslan/Resume/raw/main/static/screenshot.gif"
              alt="cover"
        ...
        <div className="flex-1 lg:ml-12">
          ...
          <p className="py-6">
            I created this dynamic resume to show my skills and experience in a
            more fun way. You can also print it as a PDF. or you can create your
            own interactive resume by forking my repo.
          </p>
