...
export const metadata: Metadata = {
  title: 'Privacy Policy for Kuray.Dev',
...
export default function Page({ params }: { params: { slug: string } }) {
  return (
    <>
      <h1>Privacy Policy for Kuray.dev</h1>
      <p className="text-sm text-center">Last updated: 2024-01-24</p>

      <h2>Introduction</h2>
      <p>At Kuray.dev, we are committed to protecting your personal information and your right to privacy. If you have any questions or concerns about our policy, or our practices with regards to your personal information, please contact us.</p>
